...
export default defineConfig({
  test: {
    ...
    // today: the one spike it carried modelled a two-branch outcome the fold
    // no longer has, and its findings live beside the code they shaped
    // (`IntentKeysOf`, `ReturnGate`). The globs stay because

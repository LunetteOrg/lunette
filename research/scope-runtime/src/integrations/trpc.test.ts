...
import { authenticate, courseSchema, resolveAdmin, resolveCourse, shapeCourse } from '../example.ts'
import { makeRepos, type Admin, type Course, type Repos, type Session } from '../domain.ts'
import { guard, leaf, type InputOf } from './trpc.ts'

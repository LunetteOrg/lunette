...
| [`outcome-vocabulary/`](./outcome-vocabulary/) | each carrier extension owns its vocabulary (in and out); the intent is inferred from what a guard/leaf returns and checked at the definition AND at the mount | the outcome-vocabulary work on #30 | that change lands in `@lntt/scope` |

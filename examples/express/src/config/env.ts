...
// the same file lives in `examples/cloudflare-workers/express`, where it can be
// run — and there it is the ONLY way bindings can arrive, since a node:http
// server has no per-request host env to thread.
export type { Env }

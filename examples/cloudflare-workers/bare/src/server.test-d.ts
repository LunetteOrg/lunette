...
// `DepGuard`, `CarrierGuard` and `IntentGuard` itself, and its carrier
// declares `cookies` and `headers` but not `body` — nothing there reads a
// request body. So the write scope, which declares a `.body` channel, cannot
// be mounted on it (§34).

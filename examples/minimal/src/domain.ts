// The in-memory domain the example exercises: an ownership + prefetch guard.
// Sessions come from a bearer token, admins from the session's user, courses
// carry an owner. No database — fixed seed data in Maps.
